...
public class RestAssuredImpl {
    ...
    public void testLogin(){
        ...
        String requestBody = "{\n" +
            "  \"email\": \"daffa.virdianto@gmail.com\",\n" +
            "  \"password\": \"D@ffa123\"\n" +
            "}";
    ...
    public void testGetAllDepartments() {
        ...
        assert response.jsonPath().getString("[0].department").equals("manager") : "Department name mismatch";
        assert response.jsonPath().getString("[1].department").equals("marketing") : "Second department name mismatch";
        assert response.jsonPath().getString("[2].department").equals("sales") : "Third department name mismatch";
        assert response.jsonPath().getString("[3].department").equals("store manager") : "Fourth department name mismatch";
        assert response.jsonPath().getString("[4].department").equals("branch manager") : "Fifth department name mismatch";
    }
    ...
    public void PartiallyUpdateObject() {
        ...
        assert response.jsonPath().getString("data.price").equals("1849.99") : "Object price mismatch";
        assert response.jsonPath().getString("data.cpu_model").equals("Intel Core i9") : "Object CPU model mismatch";
        assert response.jsonPath().getString("data.hard_disk_size").equals("1 TB") : "Object hard disk size mismatch";
        assert response.jsonPath().getString("data.capacity").equals("2 cpu") : "Object capacity mismatch";
        assert response.jsonPath().getString("data.screen_size").equals("14 Inch") : "Object screen size mismatch";
        assert response.jsonPath().getString("data.color").equals("red") : "Object color mismatch";
    }
}